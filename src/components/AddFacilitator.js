...
export default (props) => {
  ...
  // console.log("Props from fac details", props);

  const addFac = (newData) => {
    props.addFacFun(newData);
    props.history.push(`/facilitator/${groupId}`);
  };
  ...
  return (
    <div>
      ...
      <FacForm groupId={groupId} addFac={addFac} group={props.group} />
    </div>
  );
};
